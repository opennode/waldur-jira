    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.SmallIntegerField(choices=[(0, b'n/a'), (1, b'Minor'), (2, b'Major'), (3, b'Critical')], default=0)),
                ('impact', models.SmallIntegerField(choices=[(0, b'n/a'), (1, b'Small - Partial loss of service, one person affected'), (2, b'Medium - One department or service is affected'), (3, b'Large - Whole organization or all services are affected')], default=0)),
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='structure.Project'),
        ),
        migrations.AddField(
            model_name='jiraserviceprojectlink',
            name='service',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='waldur_jira.JiraService'),
        ),
        migrations.AddField(
            model_name='jiraservice',
            name='projects',
            field=models.ManyToManyField(related_name='jira_services', through='waldur_jira.JiraServiceProjectLink', to='structure.Project'),
        ),
        migrations.AddField(
            model_name='jiraservice',
            name='settings',
        ...
        migrations.AddField(
            model_name='issue',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issues', to='waldur_jira.Project'),
        ),
        migrations.AddField(
            model_name='issue',
            name='user',
        ...
        migrations.AddField(
            model_name='comment',
            name='issue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='waldur_jira.Issue'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
        ...
        migrations.AddField(
            ...
            name='issue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='waldur_jira.Issue'),
        ),
        migrations.AddField(
            model_name='attachment',
            name='user',
