...
PERMISSION_LOGICS = (
    ...
    ('nodeconductor_jira.Issue', structure_perms.property_permission_logic('project')),
    ('nodeconductor_jira.Comment', structure_perms.property_permission_logic('issue__project')),
    ('nodeconductor_jira.Attachment', structure_perms.property_permission_logic('issue__project')),
)
